    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <form method="POST" action="{{ route('blogs.update', $blog->id) }}" class="bg-white rounded shadow p-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="title" id="title" class="form-input rounded-md shadow-sm border-gray-300"
                    value="{{ $blog->title }}">
            </div>

            <div class="mb-4">
                <label for="author" class="block text-gray-700 font-bold mb-2">Author</label>
                <input type="text" name="author" id="author" class="form-input rounded-md shadow-sm border-gray-300"
                    value="{{ $blog->author }}">
            </div>
